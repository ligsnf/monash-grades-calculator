  ...
  return (
    <div className="container p-2 mb-2 mx-auto space-y-8">
      <section className="space-y-4">
        ...
        <p>
          This calculator provides a streamlined way to calculate both your
          Weighted Average Mark (WAM) and Grade Point Average (GPA) in one
          place. It was developed to offer Monash University students a more
      ...
      <section className="space-y-4">
        ...
        <p>
          The calculator uses Monash University&apos;s official calculation
          methods for both WAM and GPA. You can import your results via CSV or
          enter them manually, and see your calculations update in real-time.
        </p>
        ...
        <p className="text-sm text-muted-foreground">
          All calculations are performed locally in your browser - no data is
          sent to any server.
        </p>
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <a
                href="https://www.monash.edu/students/admin/assessments/results/results-legend"
            ...
            <li>
              <a
                href="https://www.monash.edu/students/admin/assessments/results/wam"
                className="text-primary hover:underline"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <section className="space-y-4">
        ...
        <p>
          This project is open source and available on GitHub. Found a bug or
          have a suggestion? Feel free to contribute or raise an issue!
        </p>
