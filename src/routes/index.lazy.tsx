...
function Index() {
  ...
  const [, setDeletedItems] = useState<Map<number, Result>>(
          ...
          <CardHeader>
            <div className="flex justify-between">
              <div className="flex items-center gap-2 font-medium">
                ...
                <p className="hidden md:inline lg:hidden text-muted-foreground">
                  Credit points:
                </p>
                <p className="hidden lg:inline text-muted-foreground">
                  Total credit points:
                </p>
                <span className="font-mono font-semibold text-lg sm:text-xl">
                  {totalCredits}
                </span>
              </div>
